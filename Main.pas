...
begin
  if MessageBox(Handle, 'Вы действительно хотите установить все значения по умолчанию?', 'Внимание', MB_ICONWARNING or MB_YESNOCANCEL or MB_DEFBUTTON2) <> IDYES then
    Exit;
  DefaultSettings;
  PutSettings;
end;
